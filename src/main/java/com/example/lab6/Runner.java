...
public class Runner implements CommandLineRunner {
    ...
    private static final String directExchangeName = "SeleznevVA-direct-exchange-2103829";
    private static final String fanoutExchangeName = "SeleznevVA-fanout-exchange-2103829";
